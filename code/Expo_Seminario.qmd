...
6.   Asortatividad: Medición de la homofilia ^[Nodos similares tienen a conectarse entre sí] del grafo, basándose en las etiquetas de los nodos
7.   Distancia media: calcula la media de todos los caminos entre diferentes nodos
8.   Diámetro: Distancia más grande del grafo ^[Distancia es la caminata más corta entre dos nodos] 
